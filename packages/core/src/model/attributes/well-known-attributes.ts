...
export const WELL_KNOWN_TYPES: ReadonlyMap<
  string,
  { target: AttrTarget | AttrRelTarget; type: AttrType; defaultValue: AttrValue }
> = new Map([
  [
    'BusType',
    {
      target: 'network',
      type: { kind: 'enum', values: ['CAN', 'FlexRay', 'LIN', 'MOST'] },
      defaultValue: 'CAN',
    },
  ],
  [
    'Baudrate',
    { target: 'network', type: { kind: 'int', min: 0, max: 1_000_000 }, defaultValue: 500000 },
  ],
  ...
  [
    ...
    {
      target: 'network',
      type: { kind: 'enum', values: ['CAN', 'J1939', 'CANopen', 'TTP'] },
      defaultValue: 'CAN',
    },
  ],
  [
    'GenMsgCycleTime',
    { target: 'message', type: { kind: 'int', min: 0, max: 65535 }, defaultValue: 0 },
  ],
  [
    'GenMsgSendType',
    {
  ...
  [
    'VFrameFormat',
    {
      ...
      defaultValue: 'StandardCAN',
    },
  ],
  [
    'GenSigStartValue',
    { target: 'signal', type: { kind: 'float', min: -1e9, max: 1e9 }, defaultValue: 0 },
  ],
  [
    'GenSigSendType',
    {
  ...
  [
    'GenSigTimeoutTime',
    { target: 'node-signal', type: { kind: 'int', min: 0, max: 65535 }, defaultValue: 0 },
  ],
]);
