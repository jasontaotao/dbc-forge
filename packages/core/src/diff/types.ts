import type { AttributeDef, AttrValue } from '../model/attributes/attribute.js';
...
export type DiffChange =
  ...
  | {
      kind: 'attr-def-added' | 'attr-def-removed' | 'attr-def-changed';
      name: string;
      before?: AttributeDef;
      after?: AttributeDef;
    }
  | {
      ...
      target: string;
      key: string;
      before: AttrValue | undefined;
      after: AttrValue | undefined;
    }
